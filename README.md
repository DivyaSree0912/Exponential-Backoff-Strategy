...
## Retry Timeline Illustration

The following diagram compares a fixed retry strategy with an exponential backoff strategy and illustrates how retry delays increase over time.

![Exponential Backoff Strategy](images/retry_timeline_comparison.png)
